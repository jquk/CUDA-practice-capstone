...
// Constructor
NeuralNetworkGPU::NeuralNetworkGPU(int input_size, int hidden_size, int output_size) :
...
void NeuralNetworkGPU::forward_gpu(const double* d_input_data) {
...
void NeuralNetworkGPU::backward_gpu(const double* d_input_data, int target_label, double learning_rate) {
    double alpha = 1.0, beta = 0.0;
    ...
    // Predict on GPU
int NeuralNetworkGPU::predict_gpu(const double* d_image) {
